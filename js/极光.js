var rule = {
    ...
    class_name: '电影&电视剧&动漫&综艺&少儿动画&纪录片',
    class_url: 'movie&tv&cartoon&variety&child&doco',
    limit: 20,
    play_parse:true,
    // play_parse:true,
 lazy: $js.toString(() => {
    ...
    // 发起请求并解析返回的 JSON 数据
    let response = JSON.parse(request("http://180.188.46.31:6969/api?key=423d50ee2d68485a916617347bfd3fa7&url=" + input));
