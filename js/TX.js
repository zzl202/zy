var rule = {
    ...
    play_parse: true,
    lazy:'js:input="http://180.188.46.31:6969/api?key=423d50ee2d68485a916617347bfd3fa7&url="+input.split("?")[0];log(input);let html=JSON.parse(request(input));log(html);input=html.url||input',
